  ...
  "node_modules/mousetrap/mousetrap.js"(exports, module) {
    (function(window2, document2, undefined2) {
      ...
      function Mousetrap2(targetElement) {
        ...
        function _bindSequence(combo, keys3, callback, action3) {
          ...
          for (var i5 = 0; i5 < keys3.length; ++i5) {
            var isFinal = i5 + 1 === keys3.length;
            var wrappedCallback = isFinal ? _callbackAndReset : _increaseSequence(action3 || _getKeyInfo(keys3[i5 + 1]).action);
            _bindSingle(keys3[i5], wrappedCallback, action3, combo, i5);
          }
        }
      ...
      Mousetrap2.prototype.bind = function(keys3, callback, action3) {
        var self2 = this;
        keys3 = keys3 instanceof Array ? keys3 : [keys3];
        self2._bindMultiple.call(self2, keys3, callback, action3);
        return self2;
      };
      Mousetrap2.prototype.unbind = function(keys3, action3) {
        var self2 = this;
        return self2.bind.call(self2, keys3, function() {
        }, action3);
      };
      Mousetrap2.prototype.trigger = function(keys3, action3) {
        var self2 = this;
        if (self2._directMap[keys3 + ":" + action3]) {
          self2._directMap[keys3 + ":" + action3]({}, keys3);
        }
        return self2;
      };
...
function _(l3, u4, t3) {
  var i4, o2, r3, f5 = {};
  for (r3 in u4) "key" == r3 ? i4 = u4[r3] : "ref" == r3 ? o2 = u4[r3] : f5[r3] = u4[r3];
  if (arguments.length > 2 && (f5.children = arguments.length > 3 ? n.call(arguments, 2) : t3), "function" == typeof l3 && null != l3.defaultProps) for (r3 in l3.defaultProps) void 0 === f5[r3] && (f5[r3] = l3.defaultProps[r3]);
  return g(l3, f5, i4, o2, null);
}
function g(n2, t3, i4, o2, r3) {
  var f5 = { type: n2, props: t3, key: i4, ref: o2, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: null == r3 ? ++u : r3, __i: -1, __u: 0 };
...
function P() {
  var n2, u4, t3, o2, r3, e3, c3, s3;
  for (i.sort(f); n2 = i.shift(); ) n2.__d && (u4 = i.length, o2 = void 0, e3 = (r3 = (t3 = n2).__v).__e, c3 = [], s3 = [], t3.__P && ((o2 = d({}, r3)).__v = r3.__v + 1, l.vnode && l.vnode(o2), O(t3.__P, o2, r3, t3.__n, t3.__P.namespaceURI, 32 & r3.__u ? [e3] : null, c3, null == e3 ? x(r3) : e3, !!(32 & r3.__u), s3), o2.__v = r3.__v, o2.__.__k[o2.__i] = o2, j(c3, o2, s3), o2.__e != e3 && C(o2)), i.length > u4 && i.sort(f));
  P.__r = 0;
}
function S(n2, l3, u4, t3, i4, o2, r3, f5, e3, c3, s3) {
  var a3, v6, y3, d2, w4, _3 = t3 && t3.__k || p, g4 = l3.length;
  for (u4.__d = e3, $(u4, l3, _3), e3 = u4.__d, a3 = 0; a3 < g4; a3++) null != (y3 = u4.__k[a3]) && "boolean" != typeof y3 && "function" != typeof y3 && (v6 = -1 === y3.__i ? h : _3[y3.__i] || h, y3.__i = a3, O(n2, y3, v6, i4, o2, r3, f5, e3, c3, s3), d2 = y3.__e, y3.ref && v6.ref != y3.ref && (v6.ref && N(v6.ref, null, y3), s3.push(y3.ref, y3.__c || d2, y3)), null == w4 && null != d2 && (w4 = d2), 65536 & y3.__u || v6.__k === y3.__k ? e3 = I(y3, e3, n2) : "function" == typeof y3.type && void 0 !== y3.__d ? e3 = y3.__d : d2 && (e3 = d2.nextSibling), y3.__d = void 0, y3.__u &= -196609);
  u4.__d = e3, u4.__e = w4;
}
function $(n2, l3, u4) {
  var t3, i4, o2, r3, f5, e3 = l3.length, c3 = u4.length, s3 = c3, a3 = 0;
  for (n2.__k = [], t3 = 0; t3 < e3; t3++) r3 = t3 + a3, null != (i4 = n2.__k[t3] = null == (i4 = l3[t3]) || "boolean" == typeof i4 || "function" == typeof i4 ? null : "string" == typeof i4 || "number" == typeof i4 || "bigint" == typeof i4 || i4.constructor == String ? g(null, i4, null, null, null) : y(i4) ? g(k, { children: i4 }, null, null, null) : void 0 === i4.constructor && i4.__b > 0 ? g(i4.type, i4.props, i4.key, i4.ref ? i4.ref : null, i4.__v) : i4) ? (i4.__ = n2, i4.__b = n2.__b + 1, f5 = L(i4, u4, r3, s3), i4.__i = f5, o2 = null, -1 !== f5 && (s3--, (o2 = u4[f5]) && (o2.__u |= 131072)), null == o2 || null === o2.__v ? (-1 == f5 && a3--, "function" != typeof i4.type && (i4.__u |= 65536)) : f5 !== r3 && (f5 == r3 - 1 ? a3-- : f5 == r3 + 1 ? a3++ : f5 > r3 ? s3 > e3 - r3 ? a3 += f5 - r3 : a3-- : f5 < r3 && (f5 == r3 - a3 ? a3 -= f5 - r3 : a3++), f5 !== t3 + a3 && (i4.__u |= 65536))) : (o2 = u4[r3]) && null == o2.key && o2.__e && 0 == (131072 & o2.__u) && (o2.__e == n2.__d && (n2.__d = x(o2)), V(o2, o2, false), u4[r3] = null, s3--);
  if (s3) for (t3 = 0; t3 < c3; t3++) null != (o2 = u4[t3]) && 0 == (131072 & o2.__u) && (o2.__e == n2.__d && (n2.__d = x(o2)), V(o2, o2));
}
function I(n2, l3, u4) {
  var t3, i4;
...
function L(n2, l3, u4, t3) {
  var i4 = n2.key, o2 = n2.type, r3 = u4 - 1, f5 = u4 + 1, e3 = l3[u4];
  if (null === e3 || e3 && i4 == e3.key && o2 === e3.type && 0 == (131072 & e3.__u)) return u4;
  if (t3 > (null != e3 && 0 == (131072 & e3.__u) ? 1 : 0)) for (; r3 >= 0 || f5 < l3.length; ) {
    if (r3 >= 0) {
      if ((e3 = l3[r3]) && 0 == (131072 & e3.__u) && i4 == e3.key && o2 === e3.type) return r3;
      r3--;
    }
    if (f5 < l3.length) {
      if ((e3 = l3[f5]) && 0 == (131072 & e3.__u) && i4 == e3.key && o2 === e3.type) return f5;
      f5++;
    }
  }
  return -1;
...
function A(n2, l3, u4, t3, i4) {
  ...
  else if ("o" === l3[0] && "n" === l3[1]) o2 = l3 !== (l3 = l3.replace(/(PointerCapture)$|Capture$/i, "$1")), l3 = l3.toLowerCase() in n2 || "onFocusOut" === l3 || "onFocusIn" === l3 ? l3.toLowerCase().slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + o2] = u4, u4 ? t3 ? u4.u = t3.u : (u4.u = e, n2.addEventListener(l3, o2 ? s : c, o2)) : n2.removeEventListener(l3, o2 ? s : c, o2);
  else {
...
function O(n2, u4, t3, i4, o2, r3, f5, e3, c3, s3) {
  var a3, h3, p3, v6, w4, _3, g4, m3, x3, C3, M3, P3, $3, I2, H3, L3, T4 = u4.type;
  if (void 0 !== u4.constructor) return null;
  128 & t3.__u && (c3 = !!(32 & t3.__u), r3 = [e3 = u4.__e = t3.__e]), (a3 = l.__b) && a3(u4);
  n: if ("function" == typeof T4) try {
    if (m3 = u4.props, x3 = "prototype" in T4 && T4.prototype.render, C3 = (a3 = T4.contextType) && i4[a3.__c], M3 = a3 ? C3 ? C3.props.value : a3.__ : i4, t3.__c ? g4 = (h3 = u4.__c = t3.__c).__ = h3.__E : (x3 ? u4.__c = h3 = new T4(m3, M3) : (u4.__c = h3 = new b(m3, M3), h3.constructor = T4, h3.render = q), C3 && C3.sub(h3), h3.props = m3, h3.state || (h3.state = {}), h3.context = M3, h3.__n = i4, p3 = h3.__d = true, h3.__h = [], h3._sb = []), x3 && null == h3.__s && (h3.__s = h3.state), x3 && null != T4.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, T4.getDerivedStateFromProps(m3, h3.__s))), v6 = h3.props, w4 = h3.state, h3.__v = u4, p3) x3 && null == T4.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), x3 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
    else {
      if (x3 && null == T4.getDerivedStateFromProps && m3 !== v6 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(m3, M3), !h3.__e && (null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(m3, h3.__s, M3) || u4.__v === t3.__v)) {
      ...
      null != h3.componentWillUpdate && h3.componentWillUpdate(m3, h3.__s, M3), x3 && null != h3.componentDidUpdate && h3.__h.push(function() {
        h3.componentDidUpdate(v6, w4, _3);
      });
    }
    if (h3.context = M3, h3.props = m3, h3.__P = n2, h3.__e = false, $3 = l.__r, I2 = 0, x3) {
      for (h3.state = h3.__s, h3.__d = false, $3 && $3(u4), a3 = h3.render(h3.props, h3.state, h3.context), H3 = 0; H3 < h3._sb.length; H3++) h3.__h.push(h3._sb[H3]);
      h3._sb = [];
    } else do {
      h3.__d = false, $3 && $3(u4), a3 = h3.render(h3.props, h3.state, h3.context), h3.state = h3.__s;
    } while (h3.__d && ++I2 < 25);
    h3.state = h3.__s, null != h3.getChildContext && (i4 = d(d({}, i4), h3.getChildContext())), x3 && !p3 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(v6, w4)), S(n2, y(L3 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3) ? L3 : [L3], u4, t3, i4, o2, r3, f5, e3, c3, s3), h3.base = u4.__e, u4.__u &= -161, h3.__h.length && f5.push(h3), g4 && (h3.__E = h3.__ = null);
  } catch (n3) {
  ...
  else null == r3 && u4.__v === t3.__v ? (u4.__k = t3.__k, u4.__e = t3.__e) : u4.__e = z(t3.__e, u4, t3, i4, o2, r3, f5, c3, s3);
  (a3 = l.diffed) && a3(u4);
}
function j(n2, u4, t3) {
  u4.__d = void 0;
...
function z(l3, u4, t3, i4, o2, r3, f5, e3, c3) {
  var s3, a3, p3, v6, d2, _3, g4, m3 = t3.props, k3 = u4.props, b2 = u4.type;
  ...
  if (null === b2) m3 === k3 || e3 && l3.data === k3 || (l3.data = k3);
    ...
    if (r3 = r3 && n.call(l3.childNodes), m3 = t3.props || h, !e3 && null != r3) for (m3 = {}, s3 = 0; s3 < l3.attributes.length; s3++) m3[(d2 = l3.attributes[s3]).name] = d2.value;
    for (s3 in m3) if (d2 = m3[s3], "children" == s3) ;
    else if ("dangerouslySetInnerHTML" == s3) p3 = d2;
    else if ("key" !== s3 && !(s3 in k3)) {
      if ("value" == s3 && "defaultValue" in k3 || "checked" == s3 && "defaultChecked" in k3) continue;
      A(l3, s3, null, d2, o2);
    }
    for (s3 in k3) d2 = k3[s3], "children" == s3 ? v6 = d2 : "dangerouslySetInnerHTML" == s3 ? a3 = d2 : "value" == s3 ? _3 = d2 : "checked" == s3 ? g4 = d2 : "key" === s3 || e3 && "function" != typeof d2 || m3[s3] === d2 || A(l3, s3, d2, m3[s3], o2);
    if (a3) e3 || p3 && (a3.__html === p3.__html || a3.__html === l3.innerHTML) || (l3.innerHTML = a3.__html), u4.__k = [];
    else if (p3 && (l3.innerHTML = ""), S(l3, y(v6) ? v6 : [v6], u4, t3, i4, "foreignObject" === b2 ? "http://www.w3.org/1999/xhtml" : o2, r3, f5, r3 ? r3[0] : t3.__k && x(t3, 0), e3, c3), null != r3) for (s3 = r3.length; s3--; ) null != r3[s3] && w(r3[s3]);
    e3 || (s3 = "value", void 0 !== _3 && (_3 !== l3[s3] || "progress" === b2 && !_3 || "option" === b2 && _3 !== m3[s3]) && A(l3, s3, _3, m3[s3], o2), s3 = "checked", void 0 !== g4 && g4 !== l3[s3] && A(l3, s3, g4, m3[s3], o2));
  }
  return l3;
}
function N(n2, u4, t3) {
...
function V(n2, u4, t3) {
  ...
  if (i4 = n2.__k) for (o2 = 0; o2 < i4.length; o2++) i4[o2] && V(i4[o2], u4, t3 || "function" != typeof n2.type);
...
function B(u4, t3, i4) {
  var o2, r3, f5, e3;
  l.__ && l.__(u4, t3), r3 = (o2 = "function" == typeof i4) ? null : i4 && i4.__k || t3.__k, f5 = [], e3 = [], O(t3, u4 = (!o2 && i4 || t3).__k = _(k, null, [u4]), r3 || h, h, t3.namespaceURI, !o2 && i4 ? [i4] : r3 ? null : t3.firstChild ? n.call(t3.childNodes) : null, f5, !o2 && i4 ? i4 : r3 ? r3.__e : t3.firstChild, o2, e3), j(f5, u4, e3);
}
n = p.slice, l = { __e: function(n2, l3, u4, t3) {
  for (var i4, o2, r3; l3 = l3.__; ) if ((i4 = l3.__c) && !i4.__) try {
    if ((o2 = i4.constructor) && null != o2.getDerivedStateFromError && (i4.setState(o2.getDerivedStateFromError(n2)), r3 = i4.__d), null != i4.componentDidCatch && (i4.componentDidCatch(n2, t3 || {}), r3 = i4.__d), r3) return i4.__E = i4;
  } catch (l4) {
    n2 = l4;
  }
  throw n2;
...
function initializeInstance(target) {
  ...
  if (decorators) {
    ...
    var keys3 = __spread(Object.getOwnPropertySymbols(decorators), Object.keys(decorators));
    try {
      for (var keys_1 = __values(keys3), keys_1_1 = keys_1.next(); !keys_1_1.done; keys_1_1 = keys_1.next()) {
...
function extendObservableObjectWithProperties(target, properties, decorators, defaultDecorator) {
  ...
  if (true) {
    ...
    if (decorators) {
      var keys3 = getPlainObjectKeys(decorators);
      try {
        for (var keys_1 = __values(keys3), keys_1_1 = keys_1.next(); !keys_1_1.done; keys_1_1 = keys_1.next()) {
          var key = keys_1_1.value;
  ...
  startBatch();
  try {
    var keys3 = ownKeys(properties);
    try {
      for (var keys_2 = __values(keys3), keys_2_1 = keys_2.next(); !keys_2_1.done; keys_2_1 = keys_2.next()) {
...
var ObservableMap = (
  ...
  function() {
    ...
    ObservableMap2.prototype.values = function() {
      ...
      return makeIterable({
        next: function() {
          var _b = keys3.next(), done = _b.done, value = _b.value;
          return {
            done,
...
var ObservableSet = (
  ...
  function() {
    ...
    ObservableSet2.prototype.entries = function() {
      var nextIndex = 0;
      var keys3 = Array.from(this.keys());
      var values2 = Array.from(this.values());
      return makeIterable({
        next: function() {
          var index = nextIndex;
          nextIndex += 1;
          return index < values2.length ? { value: [keys3[index], values2[index]], done: false } : { done: true };
        }
      });
    };
...
function isStateless(component) {
  return !(component.prototype && component.prototype.render) && !b.isPrototypeOf(component);
}
...
function isObjectShallowModified(prev, next) {
  ...
  var keys3 = Object.keys(prev);
  if (keys3.length !== Object.keys(next).length) {
    return true;
  }
  var key = void 0;
  for (var i4 = keys3.length - 1; key = keys3[i4]; i4--) {
        ...
        if (!isRenderingPending) {
          ...
          if (_this.__$mobxIsUnmounted !== true) {
            ...
            try {
              ...
              if (!skipRender) {
                b.prototype.forceUpdate.call(_this);
              }
              hasError = false;
            } finally {
...
function observer(componentClass) {
  ...
  if (isStateless(componentClass)) {
    ...
    return observer((_temp = _class = function(_Component) {
      ...
      return _class2;
    }(b), _class.displayName = makeDisplayName(componentClass), _temp));
  }
  if (!componentClass) {
...
l.unmount = function(n2) {
  ...
  var u4 = O2(r3.__v), o2 = false, i4 = function() {
  ...
  if (this.__b) {
    if (this.__v.__k) {
      ...
      this.__v.__k[0] = A3(this.__b, r3, o2.__O = o2.__P);
    }
    this.__b = null;
  }
...
l.vnode = function(n2) {
  "string" == typeof n2.type && function(n3) {
    ...
    for (var i4 in t3) {
      var c3 = t3[i4];
      if (!("value" === i4 && "defaultValue" in t3 && null == c3 || Y && "children" === i4 && "noscript" === e3 || "class" === i4 || "className" === i4)) {
        var l3 = i4.toLowerCase();
        "defaultValue" === i4 && "value" in t3 && null == t3.value ? i4 = "value" : "download" === i4 && true === c3 ? c3 = "" : "translate" === l3 && "no" === c3 ? c3 = false : "o" === l3[0] && "n" === l3[1] ? "ondoubleclick" === l3 ? i4 = "ondblclick" : "onchange" !== l3 || "input" !== e3 && "textarea" !== e3 || $2(t3.type) ? "onfocus" === l3 ? i4 = "onfocusin" : "onblur" === l3 ? i4 = "onfocusout" : H2.test(i4) && (i4 = l3) : l3 = i4 = "oninput" : o2 && B3.test(i4) ? i4 = i4.replace(Z, "-$&").toLowerCase() : null === c3 && (c3 = void 0), "oninput" === l3 && u4[i4 = l3] && (i4 = "oninputCapture"), u4[i4] = c3;
      }
    }
...
var isIe = get_default(window, "navigator.userAgent", "").match(/MSIE|Trident/) !== null;
...
var isInSegment = function(point, start, end) {
  ...
  return x3 >= startX && x3 <= endX && y3 >= startY && y3 <= endY && Math.abs(y3 - k3 * x3 + b2) < Number.EPSILON;
};
...
var Base = (
  ...
  function(_super) {
    ...
    Base2.prototype.add = function(v1) {
      ...
      var z4 = this.z + v1.z;
      return new Point((this.x + v1.x) / z4, (this.y + v1.y) / z4);
    };
    Base2.prototype.subtract = function(v1) {
      ...
      var z4 = this.z - v1.z;
      return z4 === 0 ? new Vector(this.x - v1.x, this.y - v1.y) : new Point((this.x - v1.x) / z4, (this.y - v1.y) / z4);
    };
    return Base2;
  }(Array)
);
var Vector = (
  ...
  function(_super) {
    ...
    function Vector2(x3, y3, z4) {
      var _this = _super.call(this, x3, y3, z4 !== null && z4 !== void 0 ? z4 : 0) || this;
    ...
    Matrix2.prototype.cross = function(m1) {
      ...
      if (this.columns === m1.rows) {
        for (var i4 = 0; i4 < this.rows; i4++) {
          ...
          var _loop_1 = function(j4) {
            var column = m1.getColumn(j4);
            arr[i4][j4] = row.reduce(function(prev, r3, index) {
              return prev + r3 * column[index];
            }, 0);
          };
          for (var j3 = 0; j3 < m1.columns; j3++) {
            _loop_1(j3);
          }
        }
      }
...
function sha1(bytes) {
  ...
  for (let i4 = 0; i4 < N2; ++i4) {
    ...
    for (let t3 = 0; t3 < 80; ++t3) {
      ...
      const T4 = ROTL(a3, 5) + f4(s3, b2, c3, d2) + e3 + K2[s3] + W[t3] >>> 0;
      e3 = d2;
      d2 = c3;
      c3 = ROTL(b2, 30) >>> 0;
      b2 = a3;
...
var BaseEdgeModel = (
  ...
  function() {
    ...
    BaseEdgeModel2.prototype.getEdgeStyle = function() {
      return __assign4(__assign4({}, this.graphModel.theme.baseEdge), this.style);
    };
    BaseEdgeModel2.prototype.getAdjustPointStyle = function() {
      return __assign4({}, this.graphModel.theme.edgeAdjust);
    };
    ...
    BaseEdgeModel2.prototype.getArrowStyle = function() {
      ...
      return __assign4(__assign4(__assign4({}, edgeStyle), { fill: stroke, stroke }), arrow);
    };
    ...
    BaseEdgeModel2.prototype.setProperties = function(properties) {
      this.properties = __assign4(__assign4({}, toJS(this.properties)), formatData(properties));
      this.setAttributes();
    };
    ...
    BaseEdgeModel2.prototype.setStyle = function(key, val) {
      var _a2;
      this.style = __assign4(__assign4({}, this.style), (_a2 = {}, _a2[key] = formatData(val), _a2));
    };
    BaseEdgeModel2.prototype.setStyles = function(styles) {
      this.style = __assign4(__assign4({}, this.style), formatData(styles));
    };
    BaseEdgeModel2.prototype.updateStyles = function(styles) {
      this.style = __assign4({}, formatData(styles));
    };
    BaseEdgeModel2.prototype.formatText = function(data) {
      var _a2, _b, _c;
      var _d = this.textPosition, x3 = _d.x, y3 = _d.y;
      var text = data.text;
      var textConfig = {
        value: "",
        x: x3,
      ...
      if (text) {
        if (typeof text === "string") {
          textConfig = __assign4(__assign4({}, textConfig), { value: text });
        } else {
          textConfig = __assign4(__assign4({}, textConfig), { x: (_a2 = text.x) !== null && _a2 !== void 0 ? _a2 : x3, y: (_b = text.y) !== null && _b !== void 0 ? _b : y3, value: (_c = text.value) !== null && _c !== void 0 ? _c : "" });
    ...
    BaseEdgeModel2.prototype.updateText = function(value) {
      this.text = __assign4(__assign4({}, toJS(this.text)), { value });
    };
...
var BezierEdgeModel = (
  /** @class */
  function(_super) {
    __extends4(BezierEdgeModel2, _super);
    ...
    BezierEdgeModel2.prototype.getEdgeStyle = function() {
      ...
      return __assign5(__assign5({}, style), cloneDeep_default(bezier));
    };
    ...
    BezierEdgeModel2.prototype.getData = function() {
      ...
      return __assign5(__assign5({}, data), { pointsList });
    };
    ...
    BezierEdgeModel2.prototype.getPath = function(points) {
      var _a2 = __read6(points, 4), start = _a2[0], sNext = _a2[1], ePre = _a2[2], end = _a2[3];
    ...
    BezierEdgeModel2.prototype.moveStartPoint = function(deltaX, deltaY) {
      this.startPoint.x += deltaX;
      this.startPoint.y += deltaY;
      var _a2 = __read6(this.pointsList, 3), sNext = _a2[1], ePre = _a2[2];
      sNext.x += deltaX;
      sNext.y += deltaY;
      this.updatePath(sNext, ePre);
    };
...
var LineEdgeModel = (
  /** @class */
  function(_super) {
    __extends5(LineEdgeModel2, _super);
    function LineEdgeModel2() {
      var _this = _super.apply(this, __spreadArray4([], __read7(arguments), false)) || this;
    ...
    LineEdgeModel2.prototype.getEdgeStyle = function() {
      ...
      var style = _super.prototype.getEdgeStyle.call(this);
      return __assign6(__assign6({}, style), cloneDeep_default(line));
    };
...
var PolylineEdgeModel = (
  /** @class */
  function(_super) {
    __extends6(PolylineEdgeModel2, _super);
    function PolylineEdgeModel2() {
      var _this = _super.apply(this, __spreadArray5([], __read8(arguments), false)) || this;
    ...
    PolylineEdgeModel2.prototype.getEdgeStyle = function() {
      ...
      var style = _super.prototype.getEdgeStyle.call(this);
      return __assign7(__assign7({}, style), cloneDeep_default(polyline));
    };
    PolylineEdgeModel2.prototype.getTextPosition = function() {
      ...
      var _c = __read8(getLongestEdge(currentPositionList), 2), p1 = _c[0], p22 = _c[1];
      return {
        x: (p1.x + p22.x) / 2,
        y: (p1.y + p22.y) / 2
      };
...
var BaseNodeModel = (
  ...
  function() {
    ...
    BaseNodeModel2.prototype.formatText = function(data) {
      ...
      if (text) {
        if (typeof text === "string") {
          ...
          textConfig = __assign8(__assign8({}, textConfig), { x: (_a2 = text.x) !== null && _a2 !== void 0 ? _a2 : x3, y: (_b = text.y) !== null && _b !== void 0 ? _b : y3, value: (_c = text.value) !== null && _c !== void 0 ? _c : "" });
          if (!isUndefined_default(text.draggable)) {
            textConfig.draggable = text.draggable;
          }
          if (!isUndefined_default(text.editable)) {
    ...
    BaseNodeModel2.prototype.getNodeStyle = function() {
      return __assign8(__assign8({}, this.graphModel.theme.baseNode), this.style);
    };
    BaseNodeModel2.prototype.getTextStyle = function() {
      var nodeText = this.graphModel.theme.nodeText;
      return cloneDeep_default(nodeText);
    };
    ...
    BaseNodeModel2.prototype.getAnchorsByOffset = function() {
      ...
      if (anchorsOffset && anchorsOffset.length > 0) {
        return anchorsOffset.map(function(el, idx) {
          ...
          el = el;
          return __assign8(__assign8({}, el), { x: x3 + el.x, y: y3 + el.y, id: el.id || "".concat(id, "_").concat(idx) });
        });
      }
    ...
    Object.defineProperty(BaseNodeModel2.prototype, "anchors", {
      get: function() {
        ...
        anchors.forEach(function(anchor) {
          ...
          var _a3 = __read9(new Matrix([anchorX, anchorY, 1]).translate(-x3, -y3).rotate(rotate).translate(x3, y3)[0], 2), e3 = _a3[0], f5 = _a3[1];
          anchor.x = e3;
          anchor.y = f5;
        });
        return anchors;
    ...
    BaseNodeModel2.prototype.addNodeMoveRules = function(fn) {
    ...
    BaseNodeModel2.prototype.updateText = function(value) {
      this.text = __assign8(__assign8({}, toJS(this.text)), { value });
    };
    ...
    BaseNodeModel2.prototype.setEnableRotate = function(flag) {
      if (flag === void 0) {
        flag = true;
      }
      this.enableRotate = flag;
    };
    BaseNodeModel2.prototype.setEnableResize = function(flag) {
      if (flag === void 0) {
        flag = true;
      }
    ...
    BaseNodeModel2.prototype.setProperty = function(key, val) {
      ...
      var nextProperties = __assign8(__assign8({}, preProperties), (_a2 = {}, _a2[key] = formatData(val), _a2));
    ...
    BaseNodeModel2.prototype.setProperties = function(properties) {
      var preProperties = toJS(this.properties);
      var nextProperties = __assign8(__assign8({}, preProperties), formatData(properties));
      this.properties = nextProperties;
      this.setAttributes();
      var updateKeys = [];
    ...
    BaseNodeModel2.prototype.setStyle = function(key, val) {
      var _a2;
      this.style = __assign8(__assign8({}, this.style), (_a2 = {}, _a2[key] = formatData(val), _a2));
    };
    BaseNodeModel2.prototype.setStyles = function(styles) {
      this.style = __assign8(__assign8({}, this.style), formatData(styles));
    };
    BaseNodeModel2.prototype.updateStyles = function(styles) {
      this.style = __assign8({}, formatData(styles));
    };
    ...
    __decorate4([
      observable
    ], BaseNodeModel2.prototype, "enableRotate", void 0);
    __decorate4([
      observable
    ], BaseNodeModel2.prototype, "enableResize", void 0);
    __decorate4([
      observable
    ...
    __decorate4([
      action
    ], BaseNodeModel2.prototype, "setEnableRotate", null);
    __decorate4([
      action
    ], BaseNodeModel2.prototype, "setEnableResize", null);
    __decorate4([
      action
...
var CircleNodeModel = (
  /** @class */
  function(_super) {
    __extends7(CircleNodeModel2, _super);
    ...
    CircleNodeModel2.prototype.getNodeStyle = function() {
      ...
      return __assign9(__assign9(__assign9({}, style), cloneDeep_default(circle)), cloneDeep_default(customStyle));
    };
    ...
    __decorate5([
      observable
    ], CircleNodeModel2.prototype, "properties", void 0);
    __decorate5([
      observable
...
var DiamondNodeModel = (
  /** @class */
  function(_super) {
    __extends8(DiamondNodeModel2, _super);
    ...
    DiamondNodeModel2.prototype.getNodeStyle = function() {
      ...
      var _a2 = this.properties.style, customStyle = _a2 === void 0 ? {} : _a2;
      return __assign10(__assign10(__assign10({}, style), cloneDeep_default(diamond)), cloneDeep_default(customStyle));
    };
    ...
    Object.defineProperty(DiamondNodeModel2.prototype, "pointsPosition", {
      get: function() {
        return map_default(this.points, function(_a2) {
          var _b = __read10(_a2, 2), x3 = _b[0], y3 = _b[1];
          return { x: x3, y: y3 };
        });
      },
      enumerable: false,
    ...
    __decorate6([
      observable
    ], DiamondNodeModel2.prototype, "properties", void 0);
    __decorate6([
      computed
...
var EllipseNodeModel = (
  /** @class */
  function(_super) {
    __extends9(EllipseNodeModel2, _super);
    ...
    EllipseNodeModel2.prototype.getNodeStyle = function() {
      ...
      var _a2 = this.properties.style, customStyle = _a2 === void 0 ? {} : _a2;
      return __assign11(__assign11(__assign11({}, style), cloneDeep_default(ellipse)), cloneDeep_default(customStyle));
    };
    ...
    __decorate7([
      observable
    ], EllipseNodeModel2.prototype, "properties", void 0);
    __decorate7([
      computed
...
var PolygonNodeModel = (
  /** @class */
  function(_super) {
    __extends10(PolygonNodeModel2, _super);
    ...
    PolygonNodeModel2.prototype.getNodeStyle = function() {
      ...
      var _a2 = this.properties.style, customStyle = _a2 === void 0 ? {} : _a2;
      return __assign12(__assign12(__assign12({}, style), cloneDeep_default(polygon)), cloneDeep_default(customStyle));
    };
    ...
    PolygonNodeModel2.prototype.getDefaultAnchor = function() {
      ...
      return points.map(function(_a3, idx) {
        var _b = __read11(_a3, 2), x1 = _b[0], y1 = _b[1];
        return {
          x: x3 + x1 - width / 2,
          y: y3 + y1 - height / 2,
          id: "".concat(_this.id, "_").concat(idx)
    ...
    PolygonNodeModel2.prototype.resize = function(resizeInfo) {
      ...
      var nextPoints = map_default(this.points, function(_a2) {
        var _b = __read11(_a2, 2), x3 = _b[0], y3 = _b[1];
        return [
    ...
    __decorate8([
      observable
    ], PolygonNodeModel2.prototype, "properties", void 0);
    __decorate8([
      computed
...
var RectNodeModel = (
  /** @class */
  function(_super) {
    __extends11(RectNodeModel2, _super);
    ...
    RectNodeModel2.prototype.getNodeStyle = function() {
      ...
      var _a2 = this.properties.style, customStyle = _a2 === void 0 ? {} : _a2;
      return __assign13(__assign13(__assign13({}, style), cloneDeep_default(rect)), cloneDeep_default(customStyle));
    };
    __decorate9([
      observable
    ...
    __decorate9([
      observable
    ], RectNodeModel2.prototype, "properties", void 0);
...
var TextNodeModel = (
  /** @class */
  function(_super) {
    __extends12(TextNodeModel2, _super);
    function TextNodeModel2() {
      var _this = _super.apply(this, __spreadArray6([], __read12(arguments), false)) || this;
    ...
    TextNodeModel2.prototype.getTextStyle = function() {
      ...
      return __assign14(__assign14({}, style), cloneDeep_default(text));
    };
...
var HtmlNodeModel = (
  /** @class */
  function(_super) {
    __extends13(HtmlNodeModel2, _super);
    ...
    __decorate11([
      observable
    ], HtmlNodeModel2.prototype, "properties", void 0);
...
var EditConfigModel = (
  ...
  function() {
    function EditConfigModel2(config) {
      ...
      this.defaultConfig = {};
      assign_default(this, this.getConfigDetail(config));
    }
    ...
    EditConfigModel2.prototype.getConfigDetail = function(config) {
      var isSilentMode = config.isSilentMode, textEdit = config.textEdit;
      var conf = {};
      if (isSilentMode === false) {
        assign_default(conf, this.defaultConfig);
      }
      if (isSilentMode === true && isSilentMode !== this.isSilentMode) {
        var silentConfig = pick_default(SilentConfig, keys2);
        this.defaultConfig = {
...
var GraphModel = (
  ...
  function() {
    function GraphModel2(options) {
      ...
      this.gridSize = 1;
      this.partial = false;
      var container = options.container, partial = options.partial, _a2 = options.background, background = _a2 === void 0 ? {} : _a2, grid = options.grid, idGenerator = options.idGenerator, edgeGenerator = options.edgeGenerator, animation = options.animation, customTrajectory = options.customTrajectory;
    ...
    Object.defineProperty(GraphModel2.prototype, "modelsMap", {
      get: function() {
        return __spreadArray7(__spreadArray7([], __read13(this.nodes), false), __read13(this.edges), false).reduce(function(eMap, model) {
          eMap[model.id] = model;
          return eMap;
        }, {});
      },
    ...
    Object.defineProperty(GraphModel2.prototype, "sortElements", {
       ...
       */
      get: function() {
        var elements = __spreadArray7(__spreadArray7([], __read13(this.nodes), false), __read13(this.edges), false).sort(function(a3, b2) {
    ...
    GraphModel2.prototype.getAreaElement = function(leftTopPoint, rightBottomPoint, wholeEdge, wholeNode, ignoreHideElement) {
      ...
      var areaElements = [];
      forEach_default(__spreadArray7(__spreadArray7([], __read13(this.nodes), false), __read13(this.edges), false), function(element) {
    ...
    GraphModel2.prototype.getPointByClient = function(_a2) {
      ...
      var _b = __read13(this.transformModel.HtmlPointToCanvasPoint([
    ...
    GraphModel2.prototype.isElementInArea = function(element, lt, rb, wholeEdge, wholeNode) {
      ...
      if (element.BaseType === ElementType.NODE) {
        ...
        for (var i4 = 0; i4 < bboxPointsList.length; i4++) {
          ...
          _a2 = __read13(this.transformModel.CanvasPointToHtmlPoint([x3, y3]), 2), x3 = _a2[0], y3 = _a2[1];
    ...
    GraphModel2.prototype.modelToHistoryData = function() {
      ...
      var edges = [];
      for (var j3 = 0; j3 < this.edges.length; j3++) {
        var edgeMode = this.edges[j3];
    ...
    GraphModel2.prototype.moveNode = function(nodeId, deltaX, deltaY, isIgnoreRule) {
      ...
      _a2 = __read13(nodeModel.getMoveDistance(deltaX, deltaY, isIgnoreRule), 2), deltaX = _a2[0], deltaY = _a2[1];
    ...
    GraphModel2.prototype.addEdge = function(edgeConfig) {
      ...
      var edgeModel = new Model(__assign15(__assign15({}, edgeOriginData), { type }), this);
    ...
    GraphModel2.prototype.handleEdgeTextMove = function(edgeModel, x3, y3) {
      ...
      } else if (edgeModel.modelType === ModelType.POLYLINE_EDGE && ((_a2 = edgeModel.text) === null || _a2 === void 0 ? void 0 : _a2.value)) {
    ...
    GraphModel2.prototype.updateText = function(id, value) {
      var element = find_default(__spreadArray7(__spreadArray7([], __read13(this.nodes), false), __read13(this.edges), false), function(item) {
        return item.id === id;
      });
    ...
    GraphModel2.prototype.moveNodes = function(nodeIds, deltaX, deltaY, isIgnoreRule) {
      ...
      var nodeIdMap = nodeIds.reduce(function(acc, cur) {
        var nodeModel = _this.nodesMap[cur].model;
      ...
      for (var i4 = 0; i4 < this.edges.length; i4++) {
        ...
        if (sourceMoveDistance && targetMoveDistance && edgeModel.modelType === ModelType.POLYLINE_EDGE) {
          ;
          _a2 = __read13(sourceMoveDistance, 2), textDistanceX = _a2[0], textDistanceY = _a2[1];
          edgeModel.updatePointsList(textDistanceX, textDistanceY);
        } else {
          if (sourceMoveDistance) {
            ;
            _b = __read13(sourceMoveDistance, 2), textDistanceX = _b[0], textDistanceY = _b[1];
            edgeModel.moveStartPoint(textDistanceX, textDistanceY);
          }
          if (targetMoveDistance) {
            ;
            _c = __read13(targetMoveDistance, 2), textDistanceX = _c[0], textDistanceY = _c[1];
    ...
    GraphModel2.prototype.addNodeMoveRules = function(fn) {
    ...
    GraphModel2.prototype.getAnchorOutcomingEdge = function(anchorId) {
      var edges = [];
      this.edges.forEach(function(edge) {
    ...
    GraphModel2.prototype.setTheme = function(style) {
      this.theme = updateTheme(__assign15(__assign15({}, this.theme), style));
    };
    ...
    GraphModel2.prototype.getVirtualRectSize = function() {
      ...
      var minX = Math.min.apply(Math, __spreadArray7([], __read13(nodesX), false));
      var maxX = Math.max.apply(Math, __spreadArray7([], __read13(nodesX), false));
      var minY = Math.min.apply(Math, __spreadArray7([], __read13(nodesY), false));
      var maxY = Math.max.apply(Math, __spreadArray7([], __read13(nodesY), false));
    ...
    __decorate13([
      action
    ], GraphModel2.prototype, "getAnchorOutcomingEdge", null);
    __decorate13([
      action
...
var SnaplineModel = (
  ...
  function() {
    ...
    SnaplineModel2.prototype.getStyle = function() {
      return __assign16({}, this.graphModel.theme.snapline);
    };
    ...
    SnaplineModel2.prototype.getHorizontalSnapline = function(draggingNode, nodes) {
      ...
      return {
        ...
        position: __assign16(__assign16({}, this.position), { y: horizontalY })
      };
    };
    SnaplineModel2.prototype.getVerticalSnapline = function(draggingNode, nodes) {
      ...
      return {
        ...
        isShowVertical,
        position: __assign16(__assign16({}, this.position), { x: verticalX })
      };
    };
...
var TransformModel = (
  ...
  function() {
    ...
    TransformModel2.prototype.HtmlPointToCanvasPoint = function(point) {
      var _a2 = __read14(point, 2), x3 = _a2[0], y3 = _a2[1];
      return [
    ...
    TransformModel2.prototype.focusOn = function(targetX, targetY, width, height) {
      var _a2 = __read14(this.CanvasPointToHtmlPoint([targetX, targetY]), 2), x3 = _a2[0], y3 = _a2[1];
      var _b = __read14([width / 2 - x3, height / 2 - y3], 2), deltaX = _b[0], deltaY = _b[1];
    ...
    TransformModel2.prototype.updateTranslateLimits = function(limit) {
      var _a2;
      ;
      _a2 = __read14(Array.isArray(limit) && limit.length === 4 ? limit : translateLimitsMap[limit.toString()], 4), this.translateLimitMinX = _a2[0], this.translateLimitMinY = _a2[1], this.translateLimitMaxX = _a2[2], this.translateLimitMaxY = _a2[3];
    };
    __decorate15([
      observable
...
var CanvasOverlay = (
  /** @class */
  function(_super) {
    __extends14(CanvasOverlay2, _super);
...
function Text(props) {
  ...
  forEach_default(toPairs_default(props), function(_a3) {
    var _b2 = __read15(_a3, 2), k3 = _b2[0], v6 = _b2[1];
    if (typeof v6 !== "object") {
      attrs[k3] = v6;
    }
  });
  if (value) {
    ...
    if (rowsLength_1 > 1) {
      ...
      return u3("text", __assign18({}, attrs, { children: tSpans }));
    }
    return u3("text", __assign18({}, attrs, { children: value }));
  }
  return null;
}
function renderHtmlText(props) {
  ...
  return u3("g", { children: u3("foreignObject", { width: textRealWidth, height: foreignObjectHeight, x: x3 - textRealWidth / 2, y: y3 - foreignObjectHeight / 2, style: { overflow: "visible", textAlign: "left" }, children: u3("div", { className: "lf-node-text-auto-wrap", style: {
    ...
    width: textRealWidth,
    padding: wrapPadding
  }, children: u3("div", { className: isEllipsis ? "lf-node-text-ellipsis-content" : "lf-node-text-auto-wrap-content", title: isEllipsis ? rows.join("") : "", style: __assign18({}, props), children: rows.map(function(row) {
...
function Line(props) {
  ...
  forEach_default(toPairs_default(props), function(_a2) {
    var _b = __read16(_a2, 2), k3 = _b[0], v6 = _b[1];
    if (k3 === "style") {
      attrs[k3] = v6;
  ...
  return u3("line", __assign19({}, attrs));
}
...
function Rect(props) {
  ...
  forEach_default(toPairs_default(props), function(_a3) {
    var _b = __read17(_a3, 2), k3 = _b[0], v6 = _b[1];
    if (typeof v6 !== "object") {
      attrs[k3] = v6;
    }
  });
  ...
  attrs.x = leftTopX;
  attrs.y = leftTopY;
  return u3("rect", __assign20({}, attrs));
}
...
function Path(props) {
  ...
  forEach_default(toPairs_default(props), function(_a2) {
    var _b = __read18(_a2, 2), k3 = _b[0], v6 = _b[1];
    if (k3 === "style" || typeof v6 !== "object") {
      attrs[k3] = v6;
    }
  });
  return u3("path", __assign21({}, attrs));
}
...
function Circle(props) {
  ...
  forEach_default(toPairs_default(props), function(_a3) {
    var _b2 = __read19(_a3, 2), k3 = _b2[0], v6 = _b2[1];
    if (typeof v6 !== "object") {
      attrs[k3] = v6;
    }
  });
  ...
  return u3("circle", __assign22({}, attrs));
}
...
function Ellipse(props) {
  ...
  forEach_default(toPairs_default(props), function(_a3) {
    var _b2 = __read20(_a3, 2), k3 = _b2[0], v6 = _b2[1];
    if (typeof v6 !== "object") {
      attrs[k3] = v6;
    }
  });
  ...
  return u3("ellipse", __assign23({}, attrs));
}
...
function Polygon(props) {
  ...
  forEach_default(toPairs_default(props), function(_a3) {
    var _b = __read21(_a3, 2), k3 = _b[0], v6 = _b[1];
    if (typeof v6 !== "object") {
      attrs[k3] = v6;
    }
  });
  ...
  return u3("polygon", __assign24({}, attrs));
}
...
function Polyline(props) {
  ...
  forEach_default(toPairs_default(props), function(_a2) {
    var _b = __read22(_a2, 2), k3 = _b[0], v6 = _b[1];
    if (k3 === "style") {
      attrs[k3] = v6;
    } else if (typeof v6 !== "object") {
      attrs[k3] = v6;
  ...
  return u3("polyline", __assign25({}, attrs));
}
...
var BezierAdjustAnchor = (
  /** @class */
  function(_super) {
    __extends15(BezierAdjustAnchor2, _super);
    ...
    BezierAdjustAnchor2.prototype.render = function() {
      ...
      return u3(Circle, __assign26({ className: "lf-bezier-adjust-anchor", x: x3, y: y3 }, adjustAnchor, { onMouseDown: function(ev) {
...
var BezierAdjustOverlay = (
  /** @class */
  function(_super) {
    __extends15(BezierAdjustOverlay2, _super);
    ...
    BezierAdjustOverlay2.prototype.getBezierAdjust = function(bezier, graphModel) {
      ...
      var _a2 = __read23(pointsList, 4), start = _a2[0], sNext = _a2[1], ePre = _a2[2], end = _a2[3];
      var adjustLine = bezier.getEdgeStyle().adjustLine;
      var result = [];
      result.push(u3(Line, __assign26({ x1: start.x, y1: start.y, x2: sNext.x, y2: sNext.y }, adjustLine)));
      result.push(u3(BezierAdjustAnchor, { position: sNext, bezierModel: bezier, graphModel, type: "sNext" }, "".concat(id, "_ePre")));
      result.push(u3(Line, __assign26({ x1: end.x, y1: end.y, x2: ePre.x, y2: ePre.y }, adjustLine)));
    ...
    BezierAdjustOverlay2 = __decorate17([
      observer2
...
var BackgroundOverlay = (
  /** @class */
  function(_super) {
    __extends16(BackgroundOverlay2, _super);
    function BackgroundOverlay2() {
      return _super !== null && _super.apply(this, arguments) || this;
    }
    BackgroundOverlay2.prototype.render = function() {
      var background = this.props.background;
      return u3("div", { className: "lf-background", children: u3("div", { style: background, className: "lf-background-area" }) });
    };
...
var Grid = (
  ...
  function(_super) {
    ...
    function Grid2() {
      var _this = _super.apply(this, __spreadArray8([], __read24(arguments), false)) || this;
      _this.id = createUuid();
      return _this;
    }
    Grid2.prototype.renderDot = function() {
      var _a2 = this.props, config = _a2.config, _b = _a2.size, size = _b === void 0 ? 1 : _b, visible = _a2.visible;
    ...
    Grid2.prototype.renderMesh = function() {
      ...
      var opacity = visible ? 1 : 0;
      return u3("path", { d: d2, stroke: color, strokeWidth, opacity, fill: "transparent" });
    };
    Grid2.prototype.render = function() {
      var _a2 = this.props, type = _a2.type, _b = _a2.size, size = _b === void 0 ? 1 : _b, transformModel = _a2.graphModel.transformModel;
...
var ModificationOverlay = (
  /** @class */
  function(_super) {
    __extends18(ModificationOverlay2, _super);
    ...
    ModificationOverlay2 = __decorate19([
      observer2
...
var OutlineOverlay = (
  /** @class */
  function(_super) {
    __extends19(OutlineOverlay2, _super);
        ...
        if (element.isHovered || element.isSelected) {
          ...
          if (nodeSelectedOutline && isSelected || hoverOutline && isHovered) {
            ...
            if (isHovered) {
              ...
              attributes_1 = __assign27(__assign27({}, attributes_1), hoverStyle);
            }
            nodeOutline.push(u3(Rect, __assign27({
    ...
    OutlineOverlay2.prototype.getLineOutline = function(line) {
      ...
      return u3(Rect, __assign27({ className: "lf-outline-edge", x: x3, y: y3, width, height }, style));
    };
    OutlineOverlay2.prototype.getPolylineOutline = function(polyline) {
      ...
      return u3(Rect, __assign27({ className: "lf-outline", x: x3, y: y3, width, height }, style));
    };
...
var SnaplineOverlay = (
  /** @class */
  function(_super) {
    __extends20(SnaplineOverlay2, _super);
    ...
    SnaplineOverlay2.prototype.render = function() {
      ...
      var horizontalLine = __assign28(__assign28({ x1: -1e5, y1: y3, x2: 1e5, y2: y3 }, style), { stroke: isShowHorizontal ? style === null || style === void 0 ? void 0 : style.stroke : "none" });
      var verticalLine = __assign28(__assign28({ x1: x3, y1: -1e5, x2: x3, y2: 1e5 }, style), { stroke: isShowVertical ? style === null || style === void 0 ? void 0 : style.stroke : "none" });
      return u3("g", { className: "lf-snapline", children: [u3(Line_default, __assign28({}, horizontalLine)), u3(Line_default, __assign28({}, verticalLine))] });
    };
    SnaplineOverlay2 = __decorate21([
      observer2
    ], SnaplineOverlay2);
...
var ToolOverlay = (
  /** @class */
  function(_super) {
    __extends21(ToolOverlay2, _super);
...
var Graph = (
  /** @class */
  function(_super) {
    __extends22(Graph2, _super);
    function Graph2() {
      var _this = _super.apply(this, __spreadArray9([], __read25(arguments), false)) || this;
    ...
    Graph2.prototype.componentDidMount = function() {
      window.addEventListener("resize", throttle_default(this.handleResize, 200));
    };
    ...
    Graph2.prototype.componentWillUnmount = function() {
      window.removeEventListener("resize", throttle_default(this.handleResize, 200));
    };
    ...
    Graph2.prototype.render = function() {
      ...
      return u3("div", { className: "lf-graph", "flow-id": graphModel.flowId, children: [u3(CanvasOverlay, { graphModel, dnd, children: [u3("g", { className: "lf-base", children: map_default(graphModel.sortElements, function(nodeModel) {
        return _this.getComponent(nodeModel, graphModel);
      }) }), fakeNode ? this.getComponent(fakeNode, graphModel) : ""] }), u3(ModificationOverlay, { graphModel, children: [u3(OutlineOverlay, { graphModel }), adjustEdge ? u3(BezierAdjustOverlay, { graphModel }) : "", options.snapline !== false ? u3(SnaplineOverlay, { snaplineModel }) : ""] }), u3(ToolOverlay, { graphModel, tool }), options.background && u3(BackgroundOverlay, { background: options.background }), grid && u3(Grid, __assign29({}, grid, { graphModel }))] });
    };
    Graph2 = __decorate23([
      observer2
    ], Graph2);
...
var Anchor = (
  ...
  function(_super) {
    ...
    Object.defineProperty(Anchor2.prototype, "relateEdges", {
      get: function() {
        var _a2 = this.props, _b = _a2.graphModel, getAnchorIncomingEdge = _b.getAnchorIncomingEdge, getAnchorOutcomingEdge = _b.getAnchorOutcomingEdge, id = _a2.anchorData.id;
        return {
...
var RotateControlPoint = (
  /** @class */
  function(_super) {
    __extends24(RotateControlPoint2, _super);
  ...
  function(_super) {
    ...
    function BaseText2(props) {
      ...
      _this.mouseDownHandler = function(e3) {
        ...
        if (draggable2 || nodeTextDraggable) {
...
var ResizeControl = (
  /** @class */
  function(_super) {
    __extends27(ResizeControl2, _super);
    function ResizeControl2(props) {
      ...
      _this.triggerResizeEvent = function(preNodeData, nextNodeData) {
      ...
      _this.resizeNode = function(_a2) {
        var deltaX = _a2.deltaX, deltaY = _a2.deltaY;
        var _b = _this.nodeModel, r3 = _b.r, rx = _b.rx, ry = _b.ry, width = _b.width, height = _b.height, PCTResizeInfo = _b.PCTResizeInfo, minWidth = _b.minWidth, minHeight = _b.minHeight, maxWidth = _b.maxWidth, maxHeight = _b.maxHeight;
        ...
        var nextSize = _this.recalcResizeInfo(_this.index, resizeInfo, pct, isFreezeWidth, isFreezeHeight);
        ...
        var preNodeData = _this.nodeModel.getData();
        var nextNodeData = _this.nodeModel.resize(nextSize);
        console.log("nextNodeData ===>>>", nextNodeData);
        _this.updateEdgePointByAnchors();
        _this.triggerResizeEvent(preNodeData, nextNodeData);
      };
      _this.onDragging = function(_a2) {
        var deltaX = _a2.deltaX, deltaY = _a2.deltaY;
        var transformModel = _this.graphModel.transformModel;
        var _b = __read29(transformModel.fixDeltaXY(deltaX, deltaY), 2), dx = _b[0], dy = _b[1];
        _this.resizeNode({
          deltaX: dx,
          deltaY: dy
        });
    ...
    ResizeControl2.prototype.render = function() {
      ...
      return u3("g", { className: "lf-resize-control lf-resize-control-".concat(direction), children: u3(Rect, __assign34({ className: "lf-resize-control-content", x: x3, y: y3, width: width !== null && width !== void 0 ? width : 7, height: height !== null && height !== void 0 ? height : 7 }, restStyle, { onMouseDown: this.dragHandler.handleMouseDown })) });
    };
...
var ResizeControlGroup = (
  /** @class */
  function(_super) {
    __extends27(ResizeControlGroup2, _super);
    ...
    ResizeControlGroup2.prototype.getResizeControl = function() {
      ...
      return map_default(controlList, function(control) {
        return u3(ResizeControl, __assign34({}, control, { model, graphModel }));
      });
    };
    ResizeControlGroup2.prototype.getResizeOutline = function() {
      ...
      return u3(Rect, __assign34({}, style, { x: x3, y: y3, width, height }));
    };
  ...
  function(_super) {
    ...
    function BaseNode2(props) {
      ...
      _this.onDragging = function(_a3) {
        ...
        var _g = graphModel.editConfigModel, stopMoveGraph = _g.stopMoveGraph, autoExpand = _g.autoExpand, transformModel = graphModel.transformModel, selectNodes = graphModel.selectNodes, width = graphModel.width, height = graphModel.height, gridSize2 = graphModel.gridSize;
        ...
        var _k = __read30(transformModel.CanvasPointToHtmlPoint([x3, y3]), 2), x1 = _k[0], y1 = _k[1];
        ...
        x3 = snapToGrid(x3, gridSize2);
        y3 = snapToGrid(y3, gridSize2);
        if (!width || !height) {
        ...
        var _l = __read30(transformModel.CanvasPointToHtmlPoint([
          x3 - model2.width / 2,
          y3 - model2.height / 2
        ]), 2), leftTopX = _l[0], leftTopY = _l[1];
        var _m = __read30(transformModel.CanvasPointToHtmlPoint([
          x3 + model2.width / 2,
          y3 + model2.height / 2
        ...
        if (nearBoundary.length > 0 && !stopMoveGraph && autoExpand) {
          _this.t = createRaf(function() {
            var _a4 = __read30(nearBoundary, 2), translateX = _a4[0], translateY = _a4[1];
      ...
      _this.handleClick = function(e3) {
        ...
        if (isDoubleClick) {
          if (editConfigModel.nodeTextEdit && model2.text.editable) {
            model2.setSelected(false);
    ...
    BaseNode2.prototype.getRotateControl = function() {
      var _a2 = this.props, model = _a2.model, graphModel = _a2.graphModel;
      var isSelected = model.isSelected, isHitable = model.isHitable, enableRotate = model.enableRotate, isHovered = model.isHovered;
    ...
    BaseNode2.prototype.getResizeControl = function() {
      var _a2 = this.props, model = _a2.model, graphModel = _a2.graphModel;
      var isSelected = model.isSelected, isHitable = model.isHitable, enableResize = model.enableResize, isHovered = model.isHovered;
    ...
    BaseNode2.prototype.render = function() {
      ...
      var nodeShape;
      if (!isHitable) {
        nodeShape = u3("g", __assign35({ className: "".concat(this.getStateClassName(), " ").concat(className) }, restAttributes, { children: nodeShapeInner }));
      } else {
        if (adjustNodePosition && draggable) {
          this.stepDrag.setStep(gridSize * SCALE_X);
        }
        nodeShape = u3("g", __assign35({ className: "".concat(this.getStateClassName(), " ").concat(className), onMouseDown: this.handleMouseDown, onMouseUp: this.handleMouseUp, onClick: this.handleClick, onMouseEnter: this.setHoverOn, onMouseOver: this.setHoverOn, onMouseLeave: this.setHoverOff, onMouseOut: this.onMouseOut, onContextMenu: this.handleContextMenu }, restAttributes, { children: nodeShapeInner }));
      }
      return nodeShape;
    };
...
var RectNode = (
  ...
  function(_super) {
    ...
    RectNode2.prototype.getShape = function() {
      ...
      return u3(Rect, __assign36({}, style, { x: model.x, y: model.y, width: model.width, height: model.height, radius: model.radius }));
    };
    return RectNode2;
  }(BaseNode_default)
);
...
var CircleNode = (
  ...
  function(_super) {
    ...
    CircleNode2.prototype.getShape = function() {
      ...
      var style = model.getNodeStyle();
      return u3(Circle_default, __assign37({}, style, { x: x3, y: y3, r: r3 }));
    };
    return CircleNode2;
  }(BaseNode_default)
);
...
var PolygonNode = (
  ...
  function(_super) {
    ...
    PolygonNode2.prototype.getShape = function() {
      ...
      return u3("g", __assign38({}, attr, { children: u3(Polygon, __assign38({}, style, { points, x: x3, y: y3 })) }));
    };
    return PolygonNode2;
  }(BaseNode_default)
);
...
var DiamondNode = (
  ...
  function(_super) {
    ...
    DiamondNode2.prototype.getShape = function() {
      var model = this.props.model;
      var style = model.getNodeStyle();
      return u3("g", { children: u3(Polygon_default, __assign39({}, style, { points: model.points, x: model.x, y: model.y })) });
    };
    return DiamondNode2;
  }(BaseNode_default)
);
...
var EllipseNode = (
  ...
  function(_super) {
    ...
    EllipseNode2.prototype.getShape = function() {
      var model = this.props.model;
      var style = model.getNodeStyle();
      return u3(Ellipse_default, __assign40({}, style, { x: model.x, y: model.y, rx: model.rx, ry: model.ry }));
    };
    return EllipseNode2;
  }(BaseNode_default)
);
...
var TextNode = (
  ...
  function(_super) {
    ...
    TextNode2.prototype.getBackground = function() {
      ...
      var rectAttr = __assign41(__assign41({}, style.background), { x: x3, y: y3, width, height });
      return u3(Rect_default, __assign41({}, rectAttr));
    };
...
var HtmlNode = (
  ...
  function(_super) {
    ...
    function HtmlNode2() {
      var _this = _super.apply(this, __spreadArray10([], __read31(arguments), false)) || this;
      _this.ref = m();
      return _this;
    }
    ...
    HtmlNode2.prototype.getShape = function() {
      ...
      return u3("foreignObject", __assign42({}, style, { x: x3 - width / 2, y: y3 - height / 2, width, height, ref: this.ref }));
    };
    return HtmlNode2;
  }(BaseNode_default)
);
  ...
  function(_super) {
    ...
    function AdjustPoint2(props) {
      ...
      _this.onDragging = function(_a2) {
        ...
        var _d = __read32(transformModel.moveCanvasPointByHtml([endX, endY], deltaX, deltaY), 2), x3 = _d[0], y3 = _d[1];
        _this.setState({
          endX: x3,
          endY: y3,
          dragging: true
        ...
        } else if (type2 === AdjustType.SOURCE) {
          edgeModel2.updateStartPoint({
            x: x3,
            y: y3
          });
        } else if (type2 === AdjustType.TARGET) {
          edgeModel2.updateEndPoint({
            x: x3,
            y: y3
          });
        }
        ...
        try {
          ...
          if (info && info.node) {
            ...
            if (pass) {
              ...
              createEdgeInfo = __assign43(__assign43({ sourceAnchorId, targetAnchorId }, rest), { text: (text === null || text === void 0 ? void 0 : text.value) || "" });
              if (type2 === AdjustType.SOURCE) {
                ...
                createEdgeInfo = __assign43(__assign43({}, edgeInfo), { sourceNodeId: info.node.id, sourceAnchorId: info.anchor.id, startPoint: {
                  x: info.anchor.x,
                  y: info.anchor.y
                }, targetNodeId: edgeModel2.targetNodeId, endPoint: __assign43({}, edgeModel2.endPoint) });
                ...
                createEdgeInfo = __assign43(__assign43({}, edgeInfo), { sourceNodeId: edgeModel2.sourceNodeId, startPoint: __assign43({}, edgeModel2.startPoint), targetNodeId: info.node.id, targetAnchorId: info.anchor.id, endPoint: {
                  x: info.anchor.x,
                  y: info.anchor.y
                } });
          ...
          if (!needRecoveryEdge) {
            ...
            var edge = graphModel2.addEdge(__assign43({}, createEdgeInfo));
...
var Arrow = (
  ...
  function(_super) {
    ...
    Arrow2.prototype.getArrowAttributes = function() {
      ...
      return __assign44({ d: "M".concat(leftX, " ").concat(leftY, " L").concat(end.x, " ").concat(end.y, " L").concat(rightX, " ").concat(rightY, " z") }, style);
    };
  ...
  function(_super) {
    ...
    function BaseEdge2() {
      ...
      _this.handleMouseUp = function(e3) {
        if (!_this.startTime)
          return;
        var time = (/* @__PURE__ */ new Date()).getTime() - _this.startTime;
        if (time > 200)
          return;
        var isRightClick = e3.button === 2;
        if (isRightClick)
        ...
        if (isDoubleClick) {
          ...
          if (model.modelType === ModelType.POLYLINE_EDGE) {
            ...
            var crossPoint = getClosestPointOfPolyline({
              x: x3,
              y: y3
    ...
    BaseEdge2.prototype.getText = function() {
      ...
      return u3(LineText, { ref: this.textRef, editable: editConfigModel.edgeTextEdit && model.text.editable, model, graphModel, draggable });
    };
    ...
    BaseEdge2.prototype.getArrow = function() {
      ...
      var _d = __read33(this.getLastTwoPoints(), 2), start = _d[0], end = _d[1];
      var theta = "auto";
    ...
    BaseEdge2.prototype.getAdjustPointShape = function(x3, y3, model) {
      ...
      return u3(Circle, __assign45({ className: "lf-edge-adjust-point" }, style, { x: x3, y: y3 }));
    };
    BaseEdge2.prototype.getAdjustPoints = function() {
      var _a2 = this.props, model = _a2.model, graphModel = _a2.graphModel;
      var start = model.getAdjustStart();
      var end = model.getAdjustEnd();
      return u3("g", { children: [u3(AdjustPoint_default, __assign45({ type: AdjustType.SOURCE }, start, { getAdjustPointShape: this.getAdjustPointShape, edgeModel: model, graphModel })), u3(AdjustPoint_default, __assign45({ type: AdjustType.TARGET }, end, { getAdjustPointShape: this.getAdjustPointShape, edgeModel: model, graphModel }))] });
    };
...
var BezierEdge = (
  ...
  function(_super) {
    ...
    BezierEdge2.prototype.getEdge = function() {
      ...
      return u3(Path, __assign46({ d: path }, style, arrowConfig, isAnimation ? {
        strokeDasharray,
        stroke,
        style: {
          strokeDashoffset,
    ...
    BezierEdge2.prototype.getArrowInfo = function() {
      ...
      var _a2 = __read34(getEndTangent(points, offset), 2), ePre = _a2[0], end = _a2[1];
      var arrowInfo = {
        start: ePre,
        end,
        hover,
...
var LineEdge = (
  ...
  function(_super) {
    ...
    LineEdge2.prototype.getEdge = function() {
      ...
      var animationStyle = model.getEdgeAnimationStyle();
      var strokeDasharray = animationStyle.strokeDasharray, stroke = animationStyle.stroke, strokeDashoffset = animationStyle.strokeDashoffset, animationName = animationStyle.animationName, animationDuration = animationStyle.animationDuration, animationIterationCount = animationStyle.animationIterationCount, animationTimingFunction = animationStyle.animationTimingFunction, animationDirection = animationStyle.animationDirection;
      return u3(Line, __assign47({}, style, { x1: startPoint.x, y1: startPoint.y, x2: endPoint.x, y2: endPoint.y }, arrowConfig, isAnimation ? {
        strokeDasharray,
        stroke,
        style: {
          strokeDashoffset,
  ...
  function(_super) {
    ...
    function PolylineEdge2() {
      ...
      _this.onDragging = function(_a2) {
        ...
        var _c = __read35(transformModel.fixDeltaXY(deltaX, deltaY), 2), curDeltaX = _c[0], curDeltaY = _c[1];
    ...
    PolylineEdge2.prototype.getEdge = function() {
      ...
      var animationStyle = model.getEdgeAnimationStyle();
      var strokeDasharray = animationStyle.strokeDasharray, stroke = animationStyle.stroke, strokeDashoffset = animationStyle.strokeDashoffset, animationName = animationStyle.animationName, animationDuration = animationStyle.animationDuration, animationIterationCount = animationStyle.animationIterationCount, animationTimingFunction = animationStyle.animationTimingFunction, animationDirection = animationStyle.animationDirection;
      return u3(Polyline, __assign48({ points }, style, arrowConfig, isAnimation ? {
        strokeDasharray,
        stroke,
        style: {
          strokeDashoffset,
    ...
    PolylineEdge2.prototype.getAppendAttributes = function(appendInfo) {
      ...
      if (start.x === end.x && start.y === end.y) {
        ...
        var startPosition = getVerticalPointOfLine(__assign48(__assign48({}, config), { type: "start" }));
        var endPosition = getVerticalPointOfLine(__assign48(__assign48({}, config), { type: "end" }));
        d2 = "M".concat(startPosition.leftX, " ").concat(startPosition.leftY, "\n      L").concat(startPosition.rightX, " ").concat(startPosition.rightY, "\n      L").concat(endPosition.rightX, " ").concat(endPosition.rightY, "\n      L").concat(endPosition.leftX, " ").concat(endPosition.leftY, " z");
      }
      return {
        d: d2,
    ...
    function Dnd2(params) {
      ...
      this.dragEnter = function(e3) {
        if (!_this.nodeConfig || _this.fakeNode)
          return;
        _this.fakeNode = _this.lf.createFakeNode(__assign49(__assign49({}, _this.nodeConfig), _this.clientToLocalPoint({
          x: e3.clientX,
          y: e3.clientY
        })));
      };
      ...
      this.onDrop = function(e3) {
        ...
        _this.lf.addNode(__assign49(__assign49({}, _this.nodeConfig), _this.clientToLocalPoint({
          x: e3.clientX,
          y: e3.clientY
...
var TextEditTool = (
  ...
  function(_super) {
      ...
      if (textEditElement) {
        ...
        if (textEditElement.BaseType === ElementType.EDGE) {
          ...
          if (textWidth && overflowMode === "autoWrap") {
            autoStyle = __assign50(__assign50({}, commonAutoStyle), { width: textWidth, minWidth: textWidth, lineHeight, padding: wrapPadding });
          }
          ...
          if (modelType !== ModelType.TEXT_NODE && overflowMode === "autoWrap" || modelType === ModelType.TEXT_NODE && textWidth) {
            autoStyle = __assign50(__assign50({}, commonAutoStyle), { width: finalTextWidth, minWidth: finalTextWidth, lineHeight, padding: wrapPadding });
          }
        }
        var _e = textEditElement.text, x3 = _e.x, y3 = _e.y;
        var _f = __read36(transformModel.CanvasPointToHtmlPoint([x3, y3]), 2), left = _f[0], top_1 = _f[1];
        return {
          style: __assign50(__assign50({ left, top: top_1 }, autoStyle), inputText)
        };
      }
      return null;
    };
    TextEditTool2.prototype.componentDidUpdate = function() {
      ...
      if (this.__prevText.id !== "") {
        ...
        graphModel.eventCenter.emit(EventType.TEXT_UPDATE, {
          data: __assign50({}, this.__prevText)
        });
        this.__prevText.id = "";
    ...
    TextEditTool2.toolName = "textEdit";
  ...
  function(_super) {
    ...
    function MultipleSelect2(props) {
      ...
      _this.handleWheelEvent = function(ev) {
        ...
        (_b = (_a3 = _this.props.logicFlow.container) === null || _a3 === void 0 ? void 0 : _a3.querySelector('.lf-canvas-overlay[name="canvas-overlay"]')) === null || _b === void 0 ? void 0 : _b.dispatchEvent(newEvent);
      };
      _this.onDragging = function(_a3) {
        var deltaX = _a3.deltaX, deltaY = _a3.deltaY;
        var _b = _this.props, graphModel = _b.graphModel, logicFlow = _b.logicFlow;
        var _c = logicFlow.getTransform(), SCALE_X = _c.SCALE_X, SCALE_Y = _c.SCALE_Y;
      ...
      _this.handleContextMenu = function(ev) {
        ...
        var models = __spreadArray11([], __read37(selectElements.values()), false);
    ...
    MultipleSelect2.prototype.render = function() {
      ...
      var _d = this.props.logicFlow.getTransform(), SCALE_X = _d.SCALE_X, SCALE_Y = _d.SCALE_Y;
      ...
      _a2 = __read37(transformModel.CanvasPointToHtmlPoint([x3, y3]), 2), x3 = _a2[0], y3 = _a2[1];
      _b = __read37(transformModel.CanvasPointToHtmlPoint([x1, y1]), 2), x1 = _b[0], y1 = _b[1];
      var style = {
    ...
    MultipleSelect2.toolName = "multipleSelect";
...
// node_modules/@logicflow/core/es/tool/tool.js
var Tool = (
  /** @class */
  function() {
    function Tool2(instance) {
      ...
      if (!this.isDisabledTool(TextEditTool_default.toolName)) {
        this.registerTool(TextEditTool_default.toolName, TextEditTool_default);
      }
      if (!this.isDisabledTool(MultipleSelectTool_default.toolName)) {
        this.registerTool(MultipleSelectTool_default.toolName, MultipleSelectTool_default);
      }
    ...
    Tool2.prototype.isDisabledTool = function(toolName) {
      var _a2;
...
// node_modules/@logicflow/core/es/tool/snapline.js
...
var Keyboard = (
  ...
  function() {
      ...
      if (shortcuts) {
        if (isArray_default(shortcuts)) {
          shortcuts.forEach(function(_a3) {
            var keys4 = _a3.keys, callback2 = _a3.callback, action4 = _a3.action;
            return _this.on(keys4, callback2, action4);
          });
        } else {
          var keys3 = shortcuts.keys, callback = shortcuts.callback, action3 = shortcuts.action;
          this.on(keys3, callback, action3);
        }
      }
    };
    Keyboard2.prototype.on = function(keys3, callback, action3) {
      this.mousetrap.bind(this.getKeys(keys3), callback, action3);
    };
    ...
    Keyboard2.prototype.off = function(keys3, action3) {
      this.mousetrap.unbind(this.getKeys(keys3), action3);
    };
    ...
    Keyboard2.prototype.getKeys = function(keys3) {
      var _this = this;
      return (Array.isArray(keys3) ? keys3 : [keys3]).map(function(key) {
  ...
  function() {
    function ViewModel2(model) {
      ...
      getAllMethodsAndProperties(model).forEach(function(key) {
        ...
        Object.defineProperty(_this, key, __assign51(__assign51({}, additionalDescriptor), { configurable: true, get: function() {
          if (isComputedProp(model, key))
...
var selected = null;
function translationNodeData(nodeData, distance2) {
...
function translationEdgeData(edgeData, distance2) {
...
var LogicFlow = (
  ...
  function() {
    function LogicFlow2(options) {
      ...
      this.dnd = new dnd_default({ lf: this });
    ...
    LogicFlow2.prototype.register = function(element, fn, isObserverView) {
      ...
      if (fn) {
        var _a2 = fn(registerParam), ViewClass = _a2.view, ModelClass = _a2.model;
    ...
    LogicFlow2.prototype.addElements = function(_a2, distance2) {
      ...
      console.log("addElements", nodes, edges, distance2);
      var nodeIdMap = {};
      var elements = {
        nodes: [],
        edges: []
    ...
    LogicFlow2.prototype.getGraphData = function() {
      ...
      if (this.adapterOut) {
        return this.adapterOut.apply(this, __spreadArray12([data], __read38(params), false));
      }
      return data;
    };
    ...
    LogicFlow2.prototype.renderRawData = function(graphRawData) {
      ...
      q3(u3(Graph_default, { getView: this.getView, tool: this.tool, options: this.options, dnd: this.dnd, snaplineModel: this.snaplineModel, graphModel: this.graphModel }), this.container);
    ...
    LogicFlow2.prototype.installPlugins = function(disabledPlugins) {
      ...
      var extensionsAddByUse = Array.from(LogicFlow2.extensions, function(_a2) {
        var _b = __read38(_a2, 2), extension = _b[1];
        return extension;
      });
      var extensions = __spreadArray12(__spreadArray12([], __read38(extensionsAddByUse), false), __read38(this.plugins), false);
    ...
    LogicFlow2.prototype.installPlugin = function(extension, props) {
      ...
      if ("pluginName" in extension && "install" in extension) {
        var pluginName = extension.pluginName, install = extension.install, render_1 = extension.render;
        if (pluginName) {
      ...
      var extensionIns = new ExtensionCtor({
        ...
        props,
        options: (_a2 = this.options.pluginsOptions) !== null && _a2 !== void 0 ? _a2 : {}
      });
...
mobx/lib/mobx.module.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=chunk-6HXJDPSH.js.map
