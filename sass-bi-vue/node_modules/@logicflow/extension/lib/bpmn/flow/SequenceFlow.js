...
exports.SequenceFlow = exports.SequenceFlowView = exports.SequenceFlowModel = void 0;
...
var SequenceFlowModel = /** @class */ (function (_super) {
    ...
    function SequenceFlowModel(data, graphModel) {
        if (!data.id) {
            data.id = "Flow_".concat((0, getBpmnId_1.getBpmnId)());
        }
...
exports.SequenceFlow = {
    type: 'bpmn:sequenceFlow',
    view: SequenceFlowView,
    model: SequenceFlowModel,
};
exports.default = exports.SequenceFlow;
