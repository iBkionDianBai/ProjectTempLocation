...
var Group = /** @class */ (function () {
    ...
    Group.prototype.createAllChildNodes = function (nodeIdMap, children, current, distance) {
        ...
        children === null || children === void 0 ? void 0 : children.forEach(function (childId) {
            ...
            if (childNodeModel) {
                var x = childNodeModel.x, y = childNodeModel.y, properties = childNodeModel.properties, type = childNodeModel.type, text = childNodeModel.text, rotate = childNodeModel.rotate, children_1 = childNodeModel.children;
