...
var BaseEdge = /** @class */ (function (_super) {
        ...
        _this.handleMouseUp = function (e) {
            ...
            if (isDoubleClick) {
                ...
                if (textEditElement && textEditElement.id === model.id) {
                    graphModel.setElementStateById(model.id, constant_1.ElementState.DEFAULT);
                }
                // 边文案可编辑状态，才可以进行文案编辑
                ...
                if (model.modelType === constant_1.ModelType.POLYLINE_EDGE) {
                    var polylineEdgeModel = model;
                    var _b = graphModel.getPointByClient({
                        x: e.x,
                        y: e.y,
                    }).canvasOverlayPosition, x = _b.x, y = _b.y;
                    var crossPoint = (0, util_1.getClosestPointOfPolyline)({
                        x: x,
                        y: y,
    ...
    BaseEdge.prototype.getText = function () {
        ...
        return ((0, jsx_runtime_1.jsx)(text_1.LineText, { ref: this.textRef, editable: editConfigModel.edgeTextEdit && model.text.editable, model: model, graphModel: graphModel, draggable: draggable }));
    };
    /**
     * @deprecated
     */
    ...
    BaseEdge.prototype.getAdjustPoints = function () {
        ...
        return ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)(AdjustPoint_1.default, __assign({ type: AdjustPoint_1.AdjustType.SOURCE }, start, { getAdjustPointShape: this.getAdjustPointShape, edgeModel: model, graphModel: graphModel })), (0, jsx_runtime_1.jsx)(AdjustPoint_1.default, __assign({ type: AdjustPoint_1.AdjustType.TARGET }, end, { getAdjustPointShape: this.getAdjustPointShape, edgeModel: model, graphModel: graphModel }))] }));
    };
    /**
     * @deprecated
     */
