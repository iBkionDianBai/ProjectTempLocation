...
declare class Anchor extends Component<IProps, IState> {
    ...
    get relateEdges(): {
        incomingEdgeList: import("../model").BaseEdgeModel[];
        outcomingEdgeList: import("../model").BaseEdgeModel[];
    };
    checkEnd: (event: MouseEvent | null | undefined) => import("../model").BaseEdgeModel | null | undefined;
