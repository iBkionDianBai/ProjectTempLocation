...
var Graph = /** @class */ (function (_super) {
    ...
    Graph.prototype.componentDidMount = function () {
        window.addEventListener('resize', (0, lodash_es_1.throttle)(this.handleResize, 200));
    };
    Graph.prototype.componentDidUpdate = function () {
        this.props.graphModel.eventCenter.emit(constant_1.EventType.GRAPH_UPDATED, {});
    };
    Graph.prototype.componentWillUnmount = function () {
        window.removeEventListener('resize', (0, lodash_es_1.throttle)(this.handleResize, 200));
    };
