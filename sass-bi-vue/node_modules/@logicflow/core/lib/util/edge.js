...
var edge_1 = require("../algorithm/edge");
...
var getCrossPointInRect = function (start, end, node) {
    ...
    if (crossSegments) {
        point = (0, edge_1.getCrossPointOfLine)(start, end, crossSegments[0], crossSegments[1]);
    }
    return point;
};
...
var getSimplePoints = function (start, end, sPoint, tPoint) {
    ...
    if (startDirection === endDirection) {
        ...
        var inStart = (0, edge_1.isInSegment)(point, start, sPoint);
        var inEnd = (0, edge_1.isInSegment)(point, end, tPoint);
        if (inStart || inEnd) {
            point = {
                x: tPoint.x,
                y: sPoint.y,
...
var getClosestPointOfPolyline = function (point, points) {
    ...
    segments.forEach(function (item) {
        ...
        if (start.x === end.x) {
            ...
            var inSegment = (0, edge_1.isInSegment)(pointXY, start, end);
            if (inSegment) {
