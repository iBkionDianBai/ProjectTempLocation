...
export declare class GraphModel {
     ...
     * todo: 性能优化
     */
    get sortElements(): (BaseEdgeModel | BaseNodeModel)[];
    /**
     * 当前编辑的元素，低频操作，先循环找。
     */
    get textEditElement(): BaseEdgeModel | BaseNodeModel | undefined;
    /**
     * 当前画布所有被选中的元素
     */
    get selectElements(): Map<string, BaseEdgeModel | BaseNodeModel>;
    get selectNodes(): BaseNodeModel[];
    /**
     * 获取指定区域内的所有元素
     ...
     */
    addNode(nodeConfig: NodeConfig, eventType?: EventType, event?: MouseEvent): BaseNodeModel;
    /**
     * 将node节点位置进行grid修正
     * 同时处理node内文字的偏移量
     ...
     * @param node
     */
    getModelAfterSnapToGrid(node: NodeConfig): BaseNodeModel;
    /**
     * 克隆节点
     * @param nodeId 节点Id
     */
     ...
     * 获取所有以此锚点为终点的边
     */
    getAnchorIncomingEdge(anchorId?: string): BaseEdgeModel[];
    /**
     * TODO: 命名问题 outcoming -> outgoing or incoming
     * 获取所有以此锚点为起点的边
     */
    getAnchorOutcomingEdge(anchorId?: string): BaseEdgeModel[];
    /**
     * 获取节点连接到的所有起始节点
     */
