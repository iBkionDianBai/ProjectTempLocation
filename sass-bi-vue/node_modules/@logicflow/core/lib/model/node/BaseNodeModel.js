...
var BaseNodeModel = /** @class */ (function () {
    ...
    BaseNodeModel.prototype.initNodeData = function (data) {
        ...
        (0, lodash_es_1.assign)(this, (0, util_1.pickNodeConfig)(data)); // TODO: 确认 constructor 中赋值 properties 是否必要
    ...
    BaseNodeModel.prototype.getTextStyle = function () {
        ...
        return (0, lodash_es_1.cloneDeep)(nodeText);
    };
    /**
     * @overridable 支持重写
     * 获取当前节点旋转控制点的样式
    ...
    BaseNodeModel.prototype.setEnableRotate = function (flag) {
        if (flag === void 0) { flag = true; }
        this.enableRotate = flag;
    };
    BaseNodeModel.prototype.setEnableResize = function (flag) {
        if (flag === void 0) { flag = true; }
    ...
    BaseNodeModel.prototype.setProperty = function (key, val) {
        ...
        var nextProperties = __assign(__assign({}, preProperties), (_a = {}, _a[key] = (0, util_1.formatData)(val), _a));
    ...
    __decorate([
        mobx_1.observable
    ], BaseNodeModel.prototype, "enableRotate", void 0);
    __decorate([
        mobx_1.observable
    ], BaseNodeModel.prototype, "enableResize", void 0);
    __decorate([
        mobx_1.observable
    ...
    __decorate([
        mobx_1.action
    ], BaseNodeModel.prototype, "setEnableRotate", null);
    __decorate([
        mobx_1.action
    ], BaseNodeModel.prototype, "setEnableResize", null);
    __decorate([
        mobx_1.action
...
//# sourceMappingURL=BaseNodeModel.js.map