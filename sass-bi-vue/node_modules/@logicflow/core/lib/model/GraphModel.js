...
var GraphModel = /** @class */ (function () {
    ...
    GraphModel.prototype.handleEdgeTextMove = function (edgeModel, x, y) {
        ...
        else if (edgeModel.modelType === constant_1.ModelType.POLYLINE_EDGE &&
     ...
     * 获取所有以此锚点为起点的边
     */
    GraphModel.prototype.getAnchorOutcomingEdge = function (anchorId) {
        var edges = [];
        this.edges.forEach(function (edge) {
    ...
    __decorate([
        mobx_1.action
    ], GraphModel.prototype, "getAnchorOutcomingEdge", null);
    __decorate([
        mobx_1.action
