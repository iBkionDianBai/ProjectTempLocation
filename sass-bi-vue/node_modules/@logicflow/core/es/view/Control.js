...
import { getNodeBBox, StepDrag } from '../util';
...
var ResizeControl = /** @class */ (function (_super) {
    ...
    function ResizeControl(props) {
        ...
        _this.resizeNode = function (_a) {
            ...
            var _b = _this.nodeModel, r = _b.r, // circle
            rx = _b.rx, // ellipse/diamond
            ry = _b.ry, width = _b.width, // rect/html
            height = _b.height, PCTResizeInfo = _b.PCTResizeInfo, minWidth = _b.minWidth, minHeight = _b.minHeight, maxWidth = _b.maxWidth, maxHeight = _b.maxHeight;
    ...
    ResizeControl.prototype.render = function () {
        ...
        return (_jsx("g", { className: "lf-resize-control lf-resize-control-".concat(direction), children: _jsx(Rect, __assign({ className: "lf-resize-control-content", x: x, y: y, width: width !== null && width !== void 0 ? width : 7, height: height !== null && height !== void 0 ? height : 7 }, restStyle, { onMouseDown: this.dragHandler.handleMouseDown })) }));
    };
