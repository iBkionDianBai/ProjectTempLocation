...
var BaseEdge = /** @class */ (function (_super) {
    ...
    BaseEdge.prototype.getText = function () {
        ...
        return (_jsx(LineText, { ref: this.textRef, editable: editConfigModel.edgeTextEdit && model.text.editable, model: model, graphModel: graphModel, draggable: draggable }));
    };
    /**
     * @deprecated
     */
    ...
    BaseEdge.prototype.getAdjustPoints = function () {
        ...
        return (_jsxs("g", { children: [_jsx(AdjustPoint, __assign({ type: AdjustType.SOURCE }, start, { getAdjustPointShape: this.getAdjustPointShape, edgeModel: model, graphModel: graphModel })), _jsx(AdjustPoint, __assign({ type: AdjustType.TARGET }, end, { getAdjustPointShape: this.getAdjustPointShape, edgeModel: model, graphModel: graphModel }))] }));
    };
    /**
     * @deprecated
     */
