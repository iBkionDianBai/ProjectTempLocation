...
export declare const setupEdgeModel: (edge: EdgeConfig, graphModel: GraphModel) => BaseEdgeModel;
...
export declare const getCrossPointInRect: (start: Point, end: Point, node: BaseNodeModel) => Point;
