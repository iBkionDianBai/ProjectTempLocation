...
export declare class PolylineEdgeModel extends BaseEdgeModel {
    ...
    getAfterAnchor(direction: SegmentDirection, position: Position, anchorList: ArchorConfig[]): Model.AnchorConfig;
    ...
    getDraggingPoints(direction: SegmentDirection, positionType: string, position: Position, anchorList: ArchorConfig[], draggingPointList: Point[]): LogicFlow.Point[];
