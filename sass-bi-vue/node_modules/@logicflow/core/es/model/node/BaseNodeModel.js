...
import { ElementState, ElementType, EventType, ModelType, OverlapMode, } from '../../constant';
var BaseNodeModel = /** @class */ (function () {
    ...
    BaseNodeModel.prototype.setProperty = function (key, val) {
        ...
        var nextProperties = __assign(__assign({}, preProperties), (_a = {}, _a[key] = formatData(val), _a));
